...
CREATE CACHED TABLE reviewer.groups(
	...
	phase_id INTEGER,
	CONSTRAINT g_phase_fk FOREIGN KEY(phase_id) REFERENCES reviewer.phase(phase_id) ON DELETE CASCADE,
);
...
CREATE CACHED TABLE reviewer.study_analisys(
	...
	phase_id INTEGER,
	CONSTRAINT sa_phase_fk FOREIGN KEY(phase_id) REFERENCES reviewer.phase(phase_id) ON DELETE CASCADE,	
);
